class Pelicula:
    ...
    def costo_reproduccion(self, tarifa_por_minuto):
        ...
        return f"El costo de reproducción de la película es: ${costo_total:.2f}"
...
if __name__ == "__main__":
    pelicula1 = Pelicula(1001, "Batman: El caballero de la noche", 152, "Christopher Nolan")
    pelicula2 = Pelicula(1002, "Interestelar", 170, "Christopher Nolan")
    pelicula3 = Pelicula(1001, "Alien: Covenant", 122, "Ridley Scott")
    ...
    print(pelicula2.costo_reproduccion(100))  # Tarifa por minuto
